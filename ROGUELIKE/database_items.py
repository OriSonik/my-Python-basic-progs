...
teleportation_orb = {'name': 'teleportation_orb', 'icon': '\u001b[35m#\u001b[0m'}
small_hp_potion = {'name': 'small_hp_potion', 'icon': '\u001b[31mh\u001b[0m', 'hp': 100}
hp_potion = {'name': 'hp_potion', 'icon': '\u001b[31mH\u001b[0m', 'hp': 200}
...
philosopher_s_ice = {'name': 'philosopher_s_ice', 'icon': '\u001b[34m^\u001b[0m', 'def': 20}
...
fuertillons = {'name': 'fuertillons', 'icon': '\u001b[33m$\u001b[0m', 'value': random.randint(25,250)}
